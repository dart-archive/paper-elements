...
@HtmlImport('package:paper_elements/paper_dialog_transition_nodart.html')
library paper_elements.paper_dialog_transition;
...
@CustomElementProxy('paper-dialog-transition')
